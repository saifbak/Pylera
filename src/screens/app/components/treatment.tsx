                        ...
                        <View style={{ flex: 1, backgroundColor: COLORS.white, borderRadius: 30, paddingHorizontal: 30, }}>
                            ...
                            <View style={{ flexDirection: "row", marginTop: 5 }}>
                                <View>
                                    ...
                                    {i18next.language === "en" && <Text style={{ position: "absolute", fontSize: vs(6), left: i18next.language === "en" ? scale(112) : 0, top: vs(20), color: COLORS.secondary }}>{'®️'}</Text>}
                                    ...
                                    {i18next.language === "en" && <Text style={{ position: "absolute", fontSize: vs(6), right: i18next.language === "en" ? scale(129) : 0, bottom: vs(10), color: COLORS.secondary }}>{'®️'}</Text>}
                                                    ...
                                                    : index === 3 ?
                                                        <View style={{ flex: 1, backgroundColor: COLORS.white, borderRadius: 30, padding: 20, }}>
                                                            ...
                                                            <View>
                                                                ...
                                                                {i18next.language === "en" && <Text style={{ position: "absolute", fontSize: vs(6), right: i18next.language === "en" ? scale(170) : 0, top: vs(-3), color: COLORS.secondary }}>{'®️'}</Text>}
                                                                {i18next.language === "en" && <Text style={{ position: "absolute", fontSize: vs(6), right: i18next.language === "en" ? scale(48) : 0, top: vs(27), color: COLORS.secondary }}>{'®️'}</Text>}
                                                                {i18next.language === "en" && <Text style={{ position: "absolute", fontSize: vs(5.5), right: i18next.language === "en" ? scale(35) : 0, top: vs(12), color: COLORS.secondary }}>{'®️'}</Text>}
                                                                ...
                                                                {i18next.language === "en" && <Text style={{ position: "absolute", fontSize: vs(6), right: i18next.language === "en" ? scale(100) : 0, bottom: vs(8), color: COLORS.secondary }}>{'13'}</Text>}
                                                                {i18next.language === "ar" && <Text style={{ position: "absolute", fontSize: vs(6), left: i18next.language === "ar" ? scale(110) : 0, bottom: vs(8), color: COLORS.secondary }}>{'١٣'}</Text>}
                                                            </View>
                                                            <View>
                                                                ...
                                                                {i18next.language === "ar" && <Text style={{ position: "absolute", fontSize: vs(6), right: i18next.language === "ar" ? scale(18) : 0, bottom: vs(8), color: COLORS.secondary }}>{'١٣'}</Text>}
                                                            </View>
                                                            <View>
                                                                ...
                                                                {i18next.language === "en" && <Text style={{ position: "absolute", fontSize: vs(6), right: i18next.language === "en" ? scale(105) : 0, top: vs(6), color: COLORS.secondary }}>{'®️'}</Text>}
                                                                {/* {i18next.language === "en" && <Text style={{ position: "absolute", fontSize: vs(6), right: i18next.language === "en" ? scale(105) : 0, bottom: vs(26), color: COLORS.secondary }}>{'®️'}</Text>} */}
                                                                {i18next.language === "en" && <Text style={{ position: "absolute", fontSize: vs(6), right: i18next.language === "en" ? scale(95) : 0, top: vs(6), color: COLORS.secondary }}>{'13'}</Text>}
                                                            ...
                                                            <View style={styles.table}>
                                                                <View style={[styles.row, { flexDirection: i18next.language === "ar" ? 'row-reverse' : 'row', }]}>
                                                                    ...
                                                                    {i18next.language === "en" && <Text style={{ zIndex: 2, position: "absolute", fontSize: vs(6), left: i18next.language === "en" ? scale(175) : 0, top: vs(16), color: COLORS.secondary }}>{`®`}</Text>}
                                                            ...
                                                            <View>
                                                                ...
                                                                {i18next.language === "en" && <Text style={{ position: "absolute", fontSize: vs(6), right: i18next.language === "en" ? scale(74) : 0, bottom: vs(10), color: COLORS.secondary }}>{'13'}</Text>}
                                                                {i18next.language === "ar" && <Text style={{ position: "absolute", fontSize: vs(6), right: i18next.language === "ar" ? scale(170) : 0, bottom: vs(6), color: COLORS.secondary }}>{'١٣'}</Text>}
                                                            </View>
                                                            <View>
                                                                ...
                                                                {i18next.language === "ar" && <Text style={{ position: "absolute", fontSize: vs(6), right: i18next.language === "ar" ? scale(72) : 0, top: vs(9), color: COLORS.secondary }}>{'١٣'}</Text>}
                                                                {i18next.language === "en" && <Text style={{ position: "absolute", fontSize: vs(8), right: i18next.language === "en" ? scale(180) : 0, top: vs(9), color: COLORS.secondary }}>{'13'}</Text>}
                                                            </View>
