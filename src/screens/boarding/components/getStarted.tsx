        ...
        <View style={styles.container}>
            ...
            <View style={styles.body}>
                ...
                <View style={{ flex: 1, justifyContent: "center", }}>
                    <View style={{ justifyContent: "center", alignSelf: "center", marginTop: -140, }}>
                        <Image source={ICONS.logo} style={{ width: scale(270), height: vs(260), resizeMode: "contain", marginBottom: -40, alignSelf: "center" }} />
                    </View>
                    <View>
                    ...
                    <TouchableOpacity style={{ backgroundColor: '#4597cf', width: scale(150), height: vs(45), borderRadius: 50, alignSelf: 'center', marginBottom: -50, marginTop: 50, alignItems: "center", justifyContent: 'center' }}>
